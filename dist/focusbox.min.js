...
define('text!themes/basic/_template.html',[],function () { return '<div class="focusbox">\n\t<a class="close"></a>\n\t<div class="content">\n\t\t<!-- focusbox content is placed here -->\n\t</div>\n</div>';});

define('themes/basic/basic',['jquery', 'text!themes/basic/_template.html'], function($, template) {
	var defaults = {};
...
define('methods/_init',['jquery', 'themes/_themes'], function($, Instances) {
...
define('methods/_open',['jquery'], function($) {
...
define('methods/_close',['jquery'], function($) {
...
define('methods/_options',['jquery'], function($) {
...
define('jquery.focusbox',['jquery', 'focusbox'], function($, Focusbox) {
